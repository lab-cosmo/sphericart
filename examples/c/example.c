...
int main(int argc, char *argv[]) {
  ...
  // per-sample calculation - we reuse the same arrays for simplicity, but only
  // the first item is computed
  ...
  sphericart_compute_array_with_gradients_f(calculator_f, xyz_f, 3 * n_samples,
                                            sph_f, sph_size, dsph_f, dsph_size);
