...
#define COMPUTE_SPH_L4(x, y, z, x2, y2, z2, sph_i, SPH_IDX)                    \
  {                                                                            \
    sph_i[SPH_IDX(16)] = cast(sph_i, 4.194391357527674) * sph_i[SPH_IDX(4)] *  \
                         sph_i[SPH_IDX(8)];                                    \
...
#define COMPUTE_SPH_L5(x, y, z, x2, y2, z2, sph_i, SPH_IDX)                    \
  {                                                                            \
    ...
    sph_i[SPH_IDX(29)] = cast(sph_i, 1.427248064296125) *                      \
                         (y * sph_i[SPH_IDX(20)] + tmp * sph_i[SPH_IDX(19)]);  \
    sph_i[SPH_IDX(31)] = cast(sph_i, 1.427248064296125) *                      \
                         (x * sph_i[SPH_IDX(20)] + tmp * sph_i[SPH_IDX(21)]);  \
    sph_i[SPH_IDX(30)] = cast(sph_i, 1.403403869441083) *                      \
                         (cast(sph_i, 3.540173863740353) * sph_i[SPH_IDX(6)] * \
                              sph_i[SPH_IDX(12)] -                             \
                          z * z2 * z2);                                        \
    sph_i[SPH_IDX(35)] = -cast(sph_i, 1.048808848170152) *                     \
...
#define COMPUTE_SPH_L6(x, y, z, x2, y2, z2, sph_i, SPH_IDX)                    \
  {                                                                            \
    ...
    tmp = -cast(sph_i, 6.399218702310463) *                                    \
          (z2 * z2 - cast(sph_i, 4.188790204786391) * (sph_i)[SPH_IDX(6)] *    \
                         (sph_i)[SPH_IDX(6)]);                                 \
...
#define COMPUTE_SPH_DERIVATIVE_L6(x, y, z, x2, y2, z2, sph_i, dx_sph_i,        \
  ...
  {                                                                            \
    ...
    (dy_sph_i)[SPH_IDX(44)] =                                                  \
        ...
        (y2 * z * (sph_i)[SPH_IDX(5)] + (-cast(sph_i, 0.14940357616680) * x2 + \
...
#define HARDCODED_SPH_DERIVATIVE_MACRO(HARDCODED_LMAX, x, y, z, x2, y2, z2,    \
  ...
  if constexpr (HARDCODED_LMAX > 1) {                                          \
    COMPUTE_SPH_DERIVATIVE_L2(x, y, z, x2, y2, z2, sph_i, dx_sph_i, dy_sph_i,  \
                              dz_sph_i, SPH_IDX);                              \
  }                                                                            \
  if constexpr (HARDCODED_LMAX > 2) {                                          \
    COMPUTE_SPH_DERIVATIVE_L3(x, y, z, x2, y2, z2, sph_i, dx_sph_i, dy_sph_i,  \
                              dz_sph_i, SPH_IDX);                              \
  }                                                                            \
  if constexpr (HARDCODED_LMAX > 3) {                                          \
    COMPUTE_SPH_DERIVATIVE_L4(x, y, z, x2, y2, z2, sph_i, dx_sph_i, dy_sph_i,  \
                              dz_sph_i, SPH_IDX);                              \
  }                                                                            \
  if constexpr (HARDCODED_LMAX > 4) {                                          \
    COMPUTE_SPH_DERIVATIVE_L5(x, y, z, x2, y2, z2, sph_i, dx_sph_i, dy_sph_i,  \
                              dz_sph_i, SPH_IDX);                              \
  }                                                                            \
  if constexpr (HARDCODED_LMAX > 5) {                                          \
    COMPUTE_SPH_DERIVATIVE_L6(x, y, z, x2, y2, z2, sph_i, dx_sph_i, dy_sph_i,  \
                              dz_sph_i, SPH_IDX);                              \
  }
