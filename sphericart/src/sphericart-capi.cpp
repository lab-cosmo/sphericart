...
extern "C" void sphericart_compute_array_with_gradients(
  ...
  try {
    calculator->compute_array_with_gradients(xyz, xyz_length, sph, sph_length,
                                             dsph, dsph_length);
  } catch (const std::exception &e) {
    // TODO: better error handling
    printf("fatal error: %s\n", e.what());
...
extern "C" void sphericart_compute_array_with_hessians(
  ...
  try {
    calculator->compute_array_with_hessians(xyz, xyz_length, sph, sph_length,
                                            dsph, dsph_length, ddsph,
                                            ddsph_length);
  } catch (const std::exception &e) {
    // TODO: better error handling
    printf("fatal error: %s\n", e.what());
...
extern "C" void sphericart_compute_sample_with_gradients(
    ...
    double *sph, size_t sph_length, double *dsph, size_t dsph_length) {
  try {
    calculator->compute_sample_with_gradients(xyz, xyz_length, sph, sph_length,
                                              dsph, dsph_length);
  } catch (const std::exception &e) {
    // TODO: better error handling
    printf("fatal error: %s\n", e.what());
...
extern "C" void sphericart_compute_sample_with_hessians(
    ...
    double *ddsph, size_t ddsph_length) {
  try {
    calculator->compute_sample_with_hessians(xyz, xyz_length, sph, sph_length,
                                             dsph, dsph_length, ddsph,
                                             ddsph_length);
  } catch (const std::exception &e) {
    // TODO: better error handling
