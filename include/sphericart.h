...
void normalized_cartesian_spherical_harmonics_rl(unsigned int n_samples, unsigned int l_max, const double* prefactors, double *xyz, double *sph, double *dsph);
...
void cartesian_spherical_harmonics_l6(unsigned int n_samples, double *xyz, double *sph, double *dsph);
